...
public class SendOTPActivity implements RequestHandler<Map<String,Object>, SendOTPResponse> {
    LoginComponent loginComponent = new LoginComponent();
    Gson gson = new GsonBuilder().setPrettyPrinting().create();

    public SendOTPResponse handleRequest(Map<String,Object> event, Context context) {
        ...
        // System.out.println("Request:" + gson.toJson(sendOTPRequest)+gson.toJson(verifyOTPRequest));
